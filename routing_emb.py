...
sample_pair = ["wxai-granite-3-2b-instruct-8k-max-tokens", "wxai-llama-3-2-3b-instruct"]
...
with open(f"routing/{args.data}_emb_{K}_{pairs}_{lambda_val}_{cc}_{ec}.json", "w+") as f:
    json.dump(ans, f)