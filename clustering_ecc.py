...
with open(f"clusters/{args.data}_{nm}_{K}_{pairs}_{lambda_val}_{cc}_{ec}_{tp}_cmp.json", "w+") as f:
    json.dump(labels, f)

# get prompts from the qid, obtain cluster to prompts 
...
with open(f"clusters/{args.data}_{nm}_{K}_{pairs}_{lambda_val}_{cc}_{ec}_{tp}_prompts.json", "w+") as f:
    json.dump(clustertoprompts, f)

with open(f"clusters/{args.data}_{nm}_{K}_{pairs}_{lambda_val}_{cc}_{ec}_{tp}_embeddings.json", "w+") as f:
...
with open(f"results/{args.data}_{nm}_{K}_{pairs}_{lambda_val}_{cc}_{ec}_{tp}.json", "w+") as f:
